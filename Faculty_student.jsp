...
<%
   ...
   try{
    ...
    Connection c=  DriverManager.getConnection("jdbc:mysql://localhost:3306/student?zeroDateTimeBehaviour=convertToNull","root","root");String sql="Select * from vc_faculty where email_id='"+email+"'";
...
<center>
            ...
            <td><a href="ViewStudent.jsp?sub_id=<%=rs.getInt("sub_id") %>"><button type="button" class="delete">View</button></a></td>
            </tr>
<%
            }
            rs.close();
